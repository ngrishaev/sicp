...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname Ex1_17) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
(define (double x)
  (+ x x))
...
(define (fast-mul-iter a b)
  (cond ((= 0 b) 0)
        ((even? b) (double (fast-mul-iter a (halve b))))
        ((> b 0) (+ (fast-mul-iter a (1- b)) a))
        ((< b 0) (- (fast-mul-iter a (1+ b)) a))
        ))